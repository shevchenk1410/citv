...
class CreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'FEM_EJE1_DESEQUILIBRIO' => 'nullable|numeric',
            'FEM_EJE2_DESEQUILIBRIO' => 'nullable|numeric',
            'FEM_EJE3_DESEQUILIBRIO' => 'nullable|numeric',
            'FEM_EJE4_DESEQUILIBRIO' => 'nullable|numeric',
            'FEM_EJE5_DESEQUILIBRIO' => 'nullable|numeric',
